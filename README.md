...
![version](https://img.shields.io/badge/version-1.4.0-2E6F40)
...
5. **Share it** — tap the copy icon, or use the share icon to send it
   straight through any app on your device.

### Opened a link someone sent you?

You'll see their wilaya, their message, and who shared it (or "Anonymous" if
they chose not to say). The text box is locked while you're reading — tap
the **new idea** icon above it whenever you're ready to clear it and write
...
stored anywhere else. If you choose to stay anonymous, no name is ever
attached to your link at all.
